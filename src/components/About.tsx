  ...
  return (
    <section className="py-24 bg-gradient-dark relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 sm:px-6">
        ...
        >
          {/* Section Title */}
          <h2 className="font-display text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-semibold mb-6 md:mb-8">
          ...
          {/* Description */}
          <p className="font-body text-base sm:text-lg md:text-xl lg:text-2xl text-foreground/90 leading-relaxed mb-6 md:mb-8">
